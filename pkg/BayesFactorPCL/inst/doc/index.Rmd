...
<a id="Moreyarea"></a>
Morey, Richard D. and Rouder, Jeffrey N. (2011). Bayes Factor Approaches for Testing Interval Null Hypotheses. Psychological Methods, 16, pp. 406-419 ([PDF](http://drsmorey.org/bibtex/upload/Morey:Rouder:2011.pdf))

<a id="MoreyMCMC"></a>
Morey, Richard D. and Rouder, Jeffrey N. and Pratte, Michael S. and Speckman, Paul L. (2011). Using MCMC chain outputs to efficiently estimate Bayes factors. Journal of Mathematical Psychology, 55, pp. 368-378 ([PDF](http://drsmorey.org/bibtex/upload/Morey:etal:2011a.pdf))

<a id="Rouderregression"></a>
Default Bayes Factors for Model Selection in Regression (in press), Multivariate Behavioral Research (contact authors for PDF)
