...
gibbsContTabPoissonNull <- function(y, a, b, iterations, progress, callback, callbackInterval) {
    .Call('BayesFactor_gibbsContTabPoissonNull', PACKAGE = 'BayesFactor', y, a, b, iterations, progress, callback, callbackInterval)
}
