...
Share via<br/>
<span class="social"><a target="_blank" href="https://www.facebook.com/sharer.php?u=http://bayesfactorpcl.r-forge.r-project.org"><img src="extra/socialmedia/png/32x32/facebook.png" alt="share on facebook"/></a> <a target="_blank" href="https://twitter.com/share?text=Check%20out%20BayesFactor%20for%20Bayesian%20data%20analysis:&url=http://bayesfactorpcl.r-forge.r-project.org"><img src="extra/socialmedia/png/32x32/twitter.png" alt="tweet BayesFactor"/></a> <a target="_blank" href="http://www.reddit.com/submit?url=http://bayesfactorpcl.r-forge.r-project.org"><img src="extra/socialmedia/png/32x32/reddit.png" alt="submit to reddit" border="0" /></a> <a target="_blank" href="https://plus.google.com/share?url=http://bayesfactorpcl.r-forge.r-project.org"><img src="extra/socialmedia/png/32x32/google_plus.png" alt="submit to google plus" border="0" /></a> <a target="_blank" href="mailto:?subject=BayesFactor R package&amp;body=Check out the BayesFactor software for Bayesian analysis: http://bayesfactorpcl.r-forge.r-project.org." title="share by email"><img src="extra/socialmedia/png/32x32/email.png" alt="share by email" border="0" /></a>
</span>

----

Stable version: [CRAN page](https://cran.r-project.org/package=BayesFactor) - [Package NEWS (including version changes)](https://cran.r-project.org/web/packages/BayesFactor/NEWS) 
